...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        ref={sidebarRef}
        className={`fixed inset-y-0 left-0 z-50 bg-white dark:bg-gray-900 shadow-lg transition-all duration-300 ease-in-out  border-l border-gray-200 dark:border-gray-800
          ${
            isMobile
              ? isExpanded
                ? "w-64 translate-x-0"
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          {!isMobile && (
            <>
              <div className="absolute top-1/4 left-0 w-1 h-8 bg-golden rounded-r-full"></div>
              <div className="absolute top-1/2 left-0 w-1 h-8 bg-green-400 rounded-r-full"></div>
              <div className="absolute top-3/4 left-0 w-1 h-8 bg-golden rounded-r-full"></div>
            </>
          )}
        </div>
