  ...
  const loadData = async (tab = activeTab) => {
    ...
    try {
      if (tab === "nft") {
        ...
        // Apply search filter to the fetched data if search term exists
        ...
        const fetchedTokens = await fetchTokens(filters);
        // Apply search filter to tokens if search term exists
